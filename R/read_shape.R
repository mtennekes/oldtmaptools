...
#' @param current.projection the current projection of the shape object, if it is missing in the shape file. See \code{get_proj4} for options. Use \code{set_projection} to reproject the shape object.
