.onLoad <- function(...) {
	...
	assign(".internet", internet, envir = .OLDTMAPTOOLS_CACHE)
	assign(".underCoverage", NULL, envir = .OLDTMAPTOOLS_CACHE)
	assign(".overCoverage", NULL, envir = .OLDTMAPTOOLS_CACHE)
}
...
.OLDTMAPTOOLS_CACHE <- new.env(FALSE, parent=globalenv())
